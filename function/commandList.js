module.exports = {
    registry: [
        ...
        { name: 'pause', aliases: [], help: (msg) => ougi.pauseHelp(msg) },
        { name: 'resume', aliases: ['unpause'], help: (msg) => ougi.resumeHelp(msg) },
        { name: 'queue', aliases: ['q'], help: (msg) => ougi.queueHelp(msg) },
        { name: 'np', aliases: ['nowplaying', 'now-playing'], help: (msg) => ougi.npHelp(msg) },
        { name: 'remove', aliases: ['dequeue', 'unqueue'], help: (msg) => ougi.musicRemoveHelp(msg) },
