module.exports = async function (args, msg) {
    const helpMap = {
        ...
        react: () => ougi.reactHelp ? ougi.reactHelp(msg) : require('./reactHelp')(msg),
        reminder: () => ougi.reminderHelp ? ougi.reminderHelp(msg) : require('./reminderHelp')(msg),
        "raffle-execute": () => ougi.raffleExecuteHelp ? ougi.raffleExecuteHelp(msg) : require('./raffleExecuteHelp')(msg),
