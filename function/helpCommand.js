module.exports = async function (args, msg) {
    const helpMap = {
        ...
        play: () => ougi.musicHelp(msg),
        p: () => ougi.musicHelp(msg),
        help: () => ougi.helpEmbed(msg),
        ...
        calc: () => ougi.calcHelp(msg),
        storytell: () => ougi.storytellHelp(msg),
        balance: () => ougi.balanceHelp(msg),
        bal: () => ougi.balanceHelp(msg),
        work: () => ougi.workHelp(msg),
        daily: () => ougi.dailyHelp(msg),
        pay: () => ougi.payHelp(msg),
        leaderboard: () => ougi.leaderboardHelp(msg),
        coinflip: () => ougi.coinflipHelp(msg),
        slots: () => ougi.slotsHelp(msg),
        gamble: () => ougi.gambleHelp(msg),
        economy: () => ougi.economyHelp(msg),
        'xp-channel': () => ougi.xpChannelHelp(msg),
        seticon: () => ougi.seticonHelp(msg),
        'admin-register': () => ougi.adminRegisterHelp(msg),
        minesweeper: () => ougi.minesweeperHelp(msg),
        results: () => ougi.resultsHelp(msg)
