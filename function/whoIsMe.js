...
function whoIsMe(arguments, msg) {
  ...
  .addField("What does Ougi log in it's console?", "Ougi only logs commands containing it's prefix with their respective arguments, plus any errors that might be useful for further debugging.")
  ...
  .addField("Can I send any feedback?", "Sure! David, developer of Ougi, is always glad to receive it. Feel free to DM him, just click that huge hypermarked blue text from the top (you can also try to type his Discord tag).");
