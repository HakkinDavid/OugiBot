...
async function (arguments, msg) {
  ...
  .addFields({name: await ougi.text({ msg, stringID: "about_q2" }), value: await ougi.text({ msg, stringID: "about_a2", values: { prefix: "`ougi`" } })})
  .addFields({name: await ougi.text({ msg, stringID: "about_q3" }), value: await ougi.text({ msg, stringID: "about_a3", values: { command: "`ougi help`" } })})
