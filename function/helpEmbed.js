...
function (msg) {
  ...
  .addField("Available commands", "As of now, Ougi has these commands: `say`, `answer`, `image`, `translate`, `snipe`, `embed`, `learn`, `emoji`, `emoji-list`, `subscribe`, `unsubscribe`, `remove`, `allow`, `setnews`, `setlog`, `acknowledgement` and `info`. Still improving!");
