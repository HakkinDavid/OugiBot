...
async function (msg) {
  ...
  .addField(await ougi.text(msg, "availableCommands"), await ougi.text(msg, "availableCommandsList") + ": `say`, `answer`, `image`, `translate`, `survey`, `music`, `skip`, `lyrics`, `curl`, `snipe`, `speak`, `stats`, `embed`, `tweet`, `learn`, `forget`, `emoji`, `emoji-list`, `language`, `guildlanguage`, `newspaper`, `subscribe`, `unsubscribe`, `prefix`, `blacklist`, `allow`, `setnews`, `setlog`, `acknowledgement`, `info`. " + await ougi.text(msg, "improving"))
