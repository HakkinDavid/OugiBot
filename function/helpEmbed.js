...
async function (msg) {
  ...
  .addField(await ougi.text(msg, "availableCommands"), await ougi.text(msg, "availableCommandsList") + ": `say`, `answer`, `image`, `translate`, `dice`, `recipe`, `editsnipe`, `survey`, `skip`, `curl`, `snipe`, `speak`, `news`, `stats`, `embed`, `tweet`, `learn`, `forget`, `emoji`, `emoji-list`, `language`, `guildlanguage`, `newspaper`, `subscribe`, `unsubscribe`, `prefix`, `blacklist`, `allow`, `setnews`, `setlog`, `info`. " + await ougi.text(msg, "improving"))
