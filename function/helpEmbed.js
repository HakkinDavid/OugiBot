...
function helpEmbed(msg) {
  ...
  .addField("Available commands", "As of now, Ougi has these commands: `say`, `answer`, `image`, `translate`, `snipe`, `embed`, `learn`, `emoji`, `emoji-list`, `remove`, `allow`, `setlog` and `info`. Still improving!");
