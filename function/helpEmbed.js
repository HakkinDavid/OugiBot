...
async function (msg) {
  ...
  .addFields({name: await ougi.text(msg, "availableCommands"), value: await ougi.text(msg, "availableCommandsList") + ": `" + commandsArray.join("`,").slice(0,-1) + ". " + await ougi.text(msg, "improving")})
