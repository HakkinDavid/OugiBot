module.exports = async function (msg) {
  ...
  embed.setDescription(await ougi.text(msg, "reminderHelpDesc"))
    ...
    .addFields({ name: await ougi.text(msg, "reminder_noteField"), value: await ougi.text(msg, "reminder_noteDesc") });
